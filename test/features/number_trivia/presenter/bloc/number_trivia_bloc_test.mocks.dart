...
// in number_trivia_app/test/features/number_trivia/presenter/bloc/number_trivia_bloc_test.dart.
...
import 'package:number_trivia_app/error/failures.dart' as _i6;
...
class MockInputConverter extends _i1.Mock implements _i10.InputConverter {
  ...
  @override
  _i3.Either<_i6.Failure, int> stringToInt(String? stringNumber) =>
      (super.noSuchMethod(Invocation.method(#stringToInt, [stringNumber]),
